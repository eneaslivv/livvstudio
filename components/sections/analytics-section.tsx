    ...
    return (
        <section className="relative w-full z-10 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-20 relative">
                ...
                <div className="flex flex-col items-center w-full px-6 md:px-12 mx-auto relative z-10">
                    ...
                    <div className="w-full max-w-5xl aspect-video rounded-[10px] overflow-hidden shadow-2xl border border-stone-200/50 bg-[#FBFBF9] relative group animate-reveal delay-100">
