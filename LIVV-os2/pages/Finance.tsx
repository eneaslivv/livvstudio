...
import { ProjectFinance, Milestone, ClientFinance, FinancialHealth, Status, PageView } from '../types';
...
const MOCK_GLOBAL_EXPENSES = [
    { id: 'ge1', name: 'Figma Pro', amount: 45, category: 'tools', isImputed: true, date: '2023-10-01' },
    { id: 'ge2', name: 'AWS Cloud', amount: 120, category: 'infra', isImputed: true, date: '2023-10-01' },
    { id: 'ge3', name: 'Office Rent', amount: 1500, category: 'infra', isImputed: false, date: '2023-10-01' },
];
