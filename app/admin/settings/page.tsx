...
import { BusinessService, RoleRate, SystemUser, ProposalItem } from '@/types/livv-os';
                    ...
                    <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
                        ...
                        <div className="grid grid-cols-3 gap-6 items-end">
                            <div className="col-span-1">
                                ...
                                <select
                                    className="w-full p-2 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg text-sm outline-none font-medium text-zinc-900 dark:text-zinc-100"
